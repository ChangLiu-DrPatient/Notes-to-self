...
TRAIN_DATA_PATH=${TRAIN_DATA_PATH:-"$HOME/data/math/train.parquet"}
OUT_DIR=${OUT_DIR:-"/raid/changl9/checkpoints/${ADV_ESTIMATOR}-${REWARD_MANAGER}/${MODEL_NAME}/${DATE}-${TIME_TAG}"}
mkdir -p "$OUT_DIR"
